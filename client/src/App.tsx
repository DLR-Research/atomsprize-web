        ...
        <main>
          ...
          <div className='content-container'>
            ...
            <h3>Are donations tax-deductible?</h3>
              <p>Yes! We are fiscally sponsored through a <a href='https://hackclub.com/bank/'>501(c)(3)</a> (EIN: 81-2908499).</p>

            <h3>Who are the organizers of this prize?</h3>
              <p>Atoms.org is an organization developing new tools for funding and publishing scientific research. We have received grants from the Ethereum Foundation.</p>

            <h3>How will the prize money be spent?</h3>
              <p>The prize will be split evenly among the recipient scientists named above. To cover the costs of credit card processing fees, tax filing, and accounting, 7% goes to our nonprofit fiscal sponsor, Hack Foundation, which is dedicated to student coding education. Atoms.org will not be receiving any funds raised from the prize.</p>

            <h3>What are the donor badges?</h3>
              <p>Each donor receives a unique badge as a token of appreciation. They have been generated by an algorithm inspired by artist <a href='https://openprocessing.org/user/56835?view=sketches'>Konstantin Makhmutov</a>. Larger and earlier donations result in badges that are more likely to be visually distinct.</p>

              <p>If desired, donors can optionally claim their badge as a non-fungible token (NFT) on the xDai chain (instructions sent via email). The xDai chain ensures near-zero environmental impact and transaction fees. </p>
