      ...
      <div id='content'>
        <main>
          ...
          <div className='content-container'>
            <h2>FAQ</h2>
            <p>
              <b>Are donations tax-deductible?</b>
              Yes! We are fiscally sponsored through a <a href='https://hackclub.com/bank/'>501(c)(3)</a> (EIN: 81-2908499).
            </p>
            <p>
              <b>Who are the organizers of this prize?</b>
              Atoms.org is an organization developing new tools for funding and publishing scientific research. We have received grants from the Ethereum Foundation.
            </p>
            <p>
              <b>How will the prize money be spent?</b>
              The prize will be split evenly among the recipient scientists named above. To cover the costs of credit card processing fees, tax filing, and accounting, 7% goes to our nonprofit fiscal sponsor, Hack Foundation, which is dedicated to student coding education. Atoms.org will not be receiving any funds raised from the prize.
            </p>
            <p>
              <b>What are the donor badges?</b>
              Each donor receives a unique badge as a token of appreciation. They have been generated by an algorithm inspired by artist <a href='https://openprocessing.org/user/56835?view=sketches'>Konstantin Makhmutov</a>. Larger and earlier donations result in badges that are more likely to be visually distinct.

              If desired, donors can optionally claim their badge as a non-fungible token (NFT) on the xDai chain (instructions sent via email). The xDai chain ensures near-zero environmental impact and transaction fees. 
            </p>
          </div>
          <div className='content-container'>
