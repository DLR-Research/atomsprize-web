        ...
        <main>
          ...
          <div className='content-container'>
            ...
            <h3>Are donations tax-deductible?</h3>
              <p>Yes! We are fiscally sponsored through a <a href='https://hackclub.com/bank/'>501(c)(3)</a>, the Hack Foundation (EIN: 81-2908499).</p>

            <h3>Who are the organizers of this prize?</h3>
              <p>Atoms.org is an organization developing new tools for funding and publishing scientific research. We are supported by grants from Protocol Labs and the Ethereum Foundation.</p>
            ...
            <h3>What are the donor badges?</h3>
              ...
              <p>If desired, donors can optionally claim their badge as a non-fungible token (NFT) on the xDai chain. The xDai chain ensures near-zero environmental impact and transaction fees. </p>
